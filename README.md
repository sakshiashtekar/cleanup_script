...
The most frustrating part of the process was dealing with inconsistent formatting and messy exports. The file appeared structured at first glance, but internally it had irregular formatting, duplicate entries, and incomplete records. 
Around 20% of the leads had to be removed because they were either clearly test entries, invalid emails, missing key information, or duplicates. If I were explaining this to a non-technical manager, I would say that we didn’t lose 20% of real customers but we removed 20% of unusable or misleading data. Keeping those records would have inflated our numbers, affected reporting accuracy, and potentially wasted sales effort. Cleaning them out ensures the CRM contains only reliable data.
